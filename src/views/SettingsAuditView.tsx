...
import { Settings, Shield, Save, CheckCircle, Search, Clock, FileText, Database, Sparkles, Trash2, AlertCircle, LogOut, User } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-xs max-w-2xl">
          ...
          <form onSubmit={handleSave} className="mt-5 space-y-4 text-xs">
            ...
            <div className="pt-4 border-t border-gray-100 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-gray-800 flex items-center gap-1.5">
                    <Shield className="w-4 h-4 text-[#1f73e8]" />
                    <span>Cloud Database Authentication (Firebase)</span>
                  </h4>
                  <p className="text-[11px] text-gray-500">
                    Governs read and write access to Firestore live database with verified Google identity
                  </p>
                </div>
              ...
              <div className="bg-[#f8fbfe] p-3.5 rounded-xl border border-blue-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-gray-500 font-mono">
                      {currentUser?.email || 'Not currently signed in with Google'}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  {currentUser ? (
                    <button
                      type="button"
                      onClick={() => logout()}
                      className="px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg text-xs font-semibold flex items-center gap-1 transition-colors cursor-pointer border border-red-200"
                    >
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-white hover:bg-gray-50 text-gray-800 rounded-lg text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer border border-gray-200 shadow-2xs"
                    >
